      ...
      <div class="row g-0">
        ...
        <div class="col-md-8">
          <div class="card-body">
            ...
            <p style="font-size: 2rem; " class="card-text"><small class="text-muted">${valor}</small></p><button type="button" class="btn" onclick="carrinho('${titulo}')" btn-success">COMPRAR</button>
          </div>
        </div>
      </div>
    </div>
